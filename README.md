...
Aplikasi ini dimaksudkan untuk digunakan sebagai alat pengujian terhadap server Anda sendiri. JANGAN GUNAKANNYA UNTUK MENYERANG ORANG LAIN, kami tidak bertanggung jawab atas apa pun yang mungkin terjadi jika Anda menyerang orang lain. Juga, proyek ini membuat `DoS` serangan, jika Anda ingin menghancurkan server yang dihosting dengan baik, terserah Anda untuk meningkatkan skala serangan menggunakan  `DDoS`mendekati. Ketahui batasan dari apa yang dapat Anda lakukan, dan mekanisme pertahanan yang digunakan target Anda; misalnya, jika server web menggunakan DDoS peralatan mitigasi (seperti penyeimbangan beban), maka Anda mungkin akan gagal untuk mematikannya; router yang mengimplementasikan SYN Cookies tidak akan terpengaruh oleh  SYN-Flood attack, dan seterusnya.
